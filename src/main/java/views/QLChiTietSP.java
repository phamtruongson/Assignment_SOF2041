...
public class QLChiTietSP extends javax.swing.JFrame {
    ...
    public QLChiTietSP() {
        ...
        int index = 1;
        model.setRowCount(0);
        for (NhanVienResponse ct : service.getAllResponse()) {
            model.addRow(ct.toDataRow(index));
            index++;
        }
    }
    ...
    private void initComponents() {
        ...
        tb.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Title 1", "Title 2", "Title 3", "Title 4", "a", "nullc", "nulld", "nulle", "nullf", "nulle", "Title 11", "Title 12", "Title 13", "Title 14"
            }
        ));
